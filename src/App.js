...
const CONTRACT_ADDRESS =
  "0xc816b6CfF555C56755eb30c3f549e5eca66C0FC2";
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        let nftTxn = await connectedContract.makeAnEpicNFT("ipfs://QmeoHJNTXoGs77Gx8cd47TacacGXNjW4U6TrB5wCjZr8jD",title,description);
...
{
  return <div className='title-descriptin-div'>
